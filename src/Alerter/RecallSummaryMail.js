...
/*
  ...
  content:
    <div style='text-align: center;'>No Recalls were issued</div>

    <ul class='list'>
      <li class='link'>A Recall <a href='https://foo.com'>Learn More</a></li>
    </ul>
*/

function createBasicHTML(startDate, endDate, recalls, entities) {

    const date = `<div>${startDate.format('ll')} &mdash; ${endDate.format('ll')}</div>`;
    const content = (_.isEmpty(recalls)
        ? "<div style='text-align: center;'>No Recalls were issued</div>"
        : `<ul class='list'>${_.map(recalls, r => `<li class='link'>${entities.decode(r.title || '')} <a href='${r.shareLink}'>learn more</a></li>`).join('')} </ul>`);

    const html = `
<!doctype html><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head><title>Weekly Recall Alerts</title><!--[if !mso]><!-- --><meta http-equiv="X-UA-Compatible" content="IE=edge"><!--<![endif]--><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style type="text/css">#outlook a {
      padding: 0;
    }
...
See all Recalls at https://myrecalls.today/recalls
`;
    return plain;
}
